...
export default class AnimationManager {
    ...
    static createAnimations(scene) {
        ...
        scene.anims.create({
            ...
            frames: scene.anims.generateFrameNumbers('tyler', { start: 0, end: 2 }), // Gera números de quadros
        ...
        scene.anims.create({
            key: 'andar_esquerda',
            frames: scene.anims.generateFrameNumbers('tyler', { start: 3, end: 5 }),
            frameRate: 10,
            repeat: -1
        })
        ...
        scene.anims.create({
            key: 'andar_direita',
            frames: scene.anims.generateFrameNumbers('tyler', { start: 6, end: 8 }),
            frameRate: 10,
            repeat: -1
        })
        ...
        scene.anims.create({
            key: 'subir',
            frames: scene.anims.generateFrameNumbers('tyler', { start: 9, end: 11 }),
            frameRate: 10,
            repeat: -1
        })
    }
